      ...
      function(_dereq_, module, exports) {
        ...
        Object.assign(MediaElementPlayer.prototype, {
          ...
          buildads: function buildads(player, controls, layers) {
            ...
            console.log('TCL: buildads -> t.adsLoaded', t.adsLoaded);
            if (t.adsLoaded) {
              return;
            } else {
              t.adsLoaded = true;
            ...
            player.adsLayer.className =
              t.options.classPrefix + 'layer ' + t.options.classPrefix + 'overlay ' + t.options.classPrefix + 'ads';
            player.adsLayer.innerHTML =
          ...
          adsStartPreroll: function adsStartPreroll() {
            ...
            for (var i = 0, total = controlElements.length; i < total; i++) {
              ...
              if (
                button &&
                !mejs.Utils.hasClass(target, t.options.classPrefix + 'playpause-button') &&
          ...
          adsPrerollMeta: function adsPrerollMeta() {
            ...
            if (t.controls.querySelector('.' + t.options.classPrefix + 'duration')) {
              setTimeout(function() {
                t.controls.querySelector('.' + t.options.classPrefix + 'duration').innerHTML = mejs.Utils.secondsToTimeCode(
                  newDuration,
          ...
          adsPrerollUpdate: function adsPrerollUpdate() {
            ...
            if (t.options.adsPrerollAdEnableSkip && t.options.adsPrerollAdSkipSeconds > 0) {
              if (t.currentTime > t.options.adsPrerollAdSkipSeconds) {
                ...
                t.adsSkipMessage.innerHTML = mejs.i18n.t(
                  'mejs.ad-skip-info',
                  Math.round(t.options.adsPrerollAdSkipSeconds - t.currentTime)
                );
              }
            }
          ...
          adRestoreMainMedia: function adRestoreMainMedia() {
            ...
            console.log('TCL: adRestoreMainMedia -> t.adsCurrentMediaUrl', t.adsCurrentMediaUrl);
            t.adsCurrentMediaUrl = 'https://quera.ir/qbox/view/CZuyN2vaUM/sample.mp4';
